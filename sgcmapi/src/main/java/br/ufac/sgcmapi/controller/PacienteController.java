...
public class PacienteController implements IController<Paciente> {
    ...
    @Override
    @GetMapping("/")
    public ResponseEntity<Page<Paciente>> get(Pageable page) {
        Page<Paciente> registros = servico.get(page);
    ...
    public ResponseEntity<Page<Paciente>> get(@PathVariable("termoBusca") String termoBusca, Pageable page) {
