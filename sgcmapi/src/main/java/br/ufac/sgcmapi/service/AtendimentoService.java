...
public class AtendimentoService implements IService<Atendimento> {
    ...
    public Page<Atendimento> getAllWithPagination(
            @PositiveOrZero int pageNumber, 
            @Positive @Max(100) int pageSize, 
            String termoBusca) {
        Page<Atendimento> page = repo.busca(termoBusca, PageRequest.of(pageNumber, pageSize));
        return page;
    }

    public Page<Atendimento> getAgenda(
            @PositiveOrZero int pageNumber, 
            @Positive @Max(100) int pageSize, 
            String termoBusca) {
        Page<Atendimento> page = repo.getAgenda(termoBusca, PageRequest.of(pageNumber, pageSize));
        return page;
    }

    public Page<Atendimento> getEmAndamento(
            @PositiveOrZero int pageNumber, 
            @Positive @Max(100) int pageSize, 
            String termoBusca) {
        Page<Atendimento> page = repo.getEmAndamento(termoBusca, PageRequest.of(pageNumber, pageSize));
        return page;
    }

    public Page<Atendimento> getFinalizados(
            @PositiveOrZero int pageNumber, 
            @Positive @Max(100) int pageSize, 
            String termoBusca) {
        Page<Atendimento> page = repo.getFinalizados(termoBusca, PageRequest.of(pageNumber, pageSize));
        return page;
    }

    public Page<Atendimento> getCancelados(
            @PositiveOrZero int pageNumber, 
            @Positive @Max(100) int pageSize, 
            String termoBusca) {
        Page<Atendimento> page = repo.getCancelados(termoBusca, PageRequest.of(pageNumber, pageSize));
        return page;
    }
