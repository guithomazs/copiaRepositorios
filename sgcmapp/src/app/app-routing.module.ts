...
const routes: Routes = [
  ...
  { path: 'atendimentos', children: [
    { path: 'marcados', component: AtendimentoListComponent },
    { path: 'finalizados', component: AtendimentosFinalizadosListComponent },
    { path: 'cancelados', component: AtendimentosCanceladosListComponent },
  ]},    
