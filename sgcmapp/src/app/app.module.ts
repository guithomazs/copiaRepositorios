...
import { AtendimentosFinalizadosListComponent } from './component/atendimentos-finalizados-list/atendimentos-finalizados-list.component';
import { AtendimentosCanceladosListComponent } from './component/atendimentos-cancelados-list/atendimentos-cancelados-list.component';
import { PepeAndFooterComponent } from './component/pepe-and-footer/pepe-and-footer.component';
...
@NgModule({
  declarations: [
    ...
    LoaderComponent,
    AtendimentosFinalizadosListComponent,
    AtendimentosCanceladosListComponent,
    PepeAndFooterComponent,
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
