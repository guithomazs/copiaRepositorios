...
@Component({
  selector: 'app-atendimentos-finalizados-list',
  templateUrl: './atendimentos-finalizados-list.component.html',
  styleUrls: ['./atendimentos-finalizados-list.component.scss']
})
export class AtendimentosFinalizadosListComponent implements IList<Atendimento>, OnInit {
  ...
  get(termoBusca?: string | undefined): void {
    this.servico.getFinalizados(this.curr_page, this.page_size, termoBusca).subscribe({
      next: (resposta: any) => {
